...
--CHANGELOG--
v1.1.4 - 14 Aug 2014
- Reorganized WordPress inputs. 
- Support added for up to 4 modules on a page

v1.1.3 - 29 Jul 2014
- CSS updates

v1.1.2 - 29 May 2014
- Removed Bootstrap CSS & JS and an unnecessary CSS file

v1.1.1 - 19 Dec 2013
- Removed Bootstrap CSS & JS and an unnecessary CSS file

v1.1.0 - 8 Nov 2013
- Modules without links can be displayed
- Modules with incomplete links (text or link, not both) will be displayed as modules without links 
- Meta box advises user on fields that are not required or are required when empty
- Cleaned up code, removed unnecessary CSS and JS in the meta box
