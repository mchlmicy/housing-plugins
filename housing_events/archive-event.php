<?php 
	...
	?>
	<style>
		.housing-event.list-item .button-row a.button[data-caltype="google"] .icon{background-image: url('<?php echo plugins_url('icons/google_dark-icon.png', __FILE__ ); ?>');}
		.housing-event.list-item .button-row a.button[data-caltype="google"]:hover .icon, .housing-event.list-item .button-row a.button[data-caltype="google"]:active .icon{background-image: url('<?php echo plugins_url('icons/google_white-icon.png', __FILE__ ); ?>');}
		.housing-event.list-item .button-row a.button[data-caltype="apple"] .icon{background-image: url('<?php echo plugins_url('icons/apple_dark-icon.png', __FILE__ ); ?>');}
		.housing-event.list-item .button-row a.button[data-caltype="apple"]:hover .icon, .housing-event.list-item .button-row a.button[data-caltype="apple"]:active .icon{background-image: url('<?php echo plugins_url('icons/apple_white-icon.png', __FILE__ ); ?>');}
		.housing-event.list-item .button-row a.button[data-caltype="android"] .icon{background-image: url('<?php echo plugins_url('icons/android_dark-icon.png', __FILE__ ); ?>');}
		.housing-event.list-item .button-row a.button[data-caltype="android"]:hover .icon, .housing-event.list-item .button-row a.button[data-caltype="android"]:active .icon{background-image: url('<?php echo plugins_url('icons/android_white-icon.png', __FILE__ ); ?>');}
		.housing-event.list-item .button-row a.button[data-caltype="outlook"] .icon{background-image: url('<?php echo plugins_url('icons/ms-outlook_dark-icon.png', __FILE__ ); ?>');}
		.housing-event.list-item .button-row a.button[data-caltype="outlook"]:hover .icon, .housing-event.list-item .button-row a.button[data-caltype="outlook"]:active .icon{background-image: url('<?php echo plugins_url('icons/ms-outlook_white-icon.png', __FILE__ ); ?>');}
		.housing-event.list-item .button-row a.button[data-caltype="thunderbird"] .icon{background-image: url('<?php echo plugins_url('icons/thunderbird_dark-icon.png', __FILE__ ); ?>');}
		.housing-event.list-item .button-row a.button[data-caltype="thunderbird"]:hover .icon, .housing-event.list-item .button-row a.button[data-caltype="thunderbird"]:active .icon{background-image: url('<?php echo plugins_url('icons/thunderbird_white-icon.png', __FILE__ ); ?>');}
	</style>
    <?php 
	...
	while (have_posts()) : the_post(); 
		...
		?>
        <div class='housing-event list-item'>
            <a class='header' href="<?php echo get_permalink(); ?>"><?php echo the_title(); ?></a>
            ...
            <?php 
                ...
                ?><div class="footer"><?php
					...
					{	
						...
						{
							?><br/><strong>Students <?php if($move_type=='movein'){echo 'moving in ';}else if($move_type=='moveout'){echo 'moving out ';} ?> should use <?php
			...
			<div class="button-row">
            	<a href="<?php echo get_permalink().'/google/'; ?>" class="button" data-caltype="google" title="Google Calendar"><div class="icon"></div></a>
                <a href="<?php echo get_permalink().'/ical/'; ?>" class="button" data-caltype="apple" title="Apple iCalendar"><div class="icon"></div></a>
                <a href="<?php echo get_permalink().'/google/'; ?>" class="button" data-caltype="android" title="Android aCalendar"><div class="icon"></div></a>
                <a href="<?php echo get_permalink().'/ical/'; ?>" class="button" data-caltype="outlook" title="Microsoft Outlook"><div class="icon"></div></a>
                <a href="<?php echo get_permalink().'/ical/'; ?>" class="button" data-caltype="thunderbird" title="Mozilla Thunderbird"><div class="icon"></div></a>
            </div>
        </div>
            
		<?php 
		if($post_counter < $wp_query->found_posts){ echo '<hr style="border-bottom: none; border-left: none; border-top: 1px solid #e3e3e3; margin: 19px 0px"/>';}
	endwhile; 
